...
def main
  animation = Animation.new 'second-and-third-shifts-by-pi', 400, 190
...
#  at.putx(4).draw
  ...
  start animation
  Text.new(animation, 'a', x: 2, y: 3, color: 'blue').draw
  Text.new(animation, 'babacabc', x: 3, y: 3, color: 'gray60').draw
  pi animation, 2
  at = Text.new(animation, '^', x: 4, y: 5, color: 'blue').draw
  ...
  start animation
  Text.new(animation, 'a', x: 4, y: 3, color: 'blue').draw
  Text.new(animation, 'babacabc', x: 5, y: 3, color: 'gray60').draw
  pi animation, 4
  ...
  Text.new(animation, 'a', x: 4, y: 3, color: 'blue').draw
  Text.new(animation, 'b', x: 5, y: 3, color: 'red').draw
  Text.new(animation, 'abacabc', x: 6, y: 3, color: 'gray60').draw
  pi animation, 4
  ...
  start animation
  Text.new(animation, '_', x: 3, y: 3, color: 'blue').draw
  Text.new(animation, 'ababacabc', x: 4, y: 3, color: 'gray60').draw
  pi animation, 4
  at.draw
  ...
  start animation
  Text.new(animation, '_', x: 4, y: 3, color: 'blue').draw
  Text.new(animation, 'ababacabc', x: 5, y: 3, color: 'gray60').draw
  pi animation, 5
